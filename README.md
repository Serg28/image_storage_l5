# Image Storage
Пакет-медиахранилище для Laravel предназначенный работы с изображением, видео и документами.
...
6. [Особенности управления](#Особенности-управления)
...
Настройка title указывающее на имя раздела
```php
    'title' => "Галереи",
```

Настройка per_page указывающее количество записей отображаемых на странице
```php
    'per_page' => 20,
```
